        ...
        message.channel.send({
            embed: {
                ...
                fields: [
                    {
                        name: prefix + "radio",
                        value: "Play a radio station [Must be in VC & Must have valid station]",
                    },
                    {
                        name: prefix + "play",
                    ...
                    },
                    {
                        ...
                        value: "shows all of the stations that " + message.client.user.username + " has",
                    },
                    {
                        name: prefix + "help",
                        value: "idk why I bother adding this but this is to open up the help page",
                    },
                    {
                        name: prefix + "stop",
